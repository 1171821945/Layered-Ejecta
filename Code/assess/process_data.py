...
def get_all(dataset, model, is_imp_loss=False, is_log=False, test_dic=None):
    sum_con_mat = [0, 0, 0, 0]
    loss = 0
    iou = 0
    precisions = 0
...
#        print("precision:{}\nrecall:{}\ncon_mat:{}\niou:{}\nf1score:{}\nf2score{}\n".format(
#            precision, recall, con_mat, one_iou, 2*precision*recall/(precision + recall + 1e-8), 5*precision*recall/(4*precision + recall + 1e-8)
#        ))
