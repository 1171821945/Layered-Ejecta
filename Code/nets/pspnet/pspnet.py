...
from nets.pspnet.psp_mobilenetv2 import mobilenetv2
from nets.pspnet.psp_resnet import resnet50
...
class Resnet(nn.Module):
    def __init__(self, dilate_scale=8, pretrained=True):
        ...
        #--------------------------------------------------------------------------------------------#
        #  Modify the stride and dilation coefficient of convolution based on the downsampling factor
        #  When downsample_factor=16, we finally obtain two feature layers with shapes of 30,301024 and 30,302048, respectively
        #--------------------------------------------------------------------------------------------#
        if dilate_scale == 8:
...
class MobileNetV2(nn.Module):
    def __init__(self, downsample_factor=8, pretrained=True):
        ...
        #--------------------------------------------------------------------------------------------#
        # Modify the stride and dilation coefficient of convolution based on the downsampling factor
        # When downsample_factor=16, we finally obtain two feature layers with shapes of 30,30320 and 30,30,96, respectively
        #--------------------------------------------------------------------------------------------#
...
class _PSPModule(nn.Module):
    def __init__(self, in_channels, pool_sizes, norm_layer):
        ...
        #-----------------------------------------------------#
        #   Perform average pooling across different regions
...
class PSPNet(nn.Module):
    def __init__(self, num_classes, downsample_factor, backbone="resnet50", pretrained=True, aux_branch=True):
        ...
        if backbone=="resnet50":
            ...
            # F4 is the auxiliary branch [30,30,96]
            # O is the main part [30,30320]
            #----------------------------------#
        ...
        #   Divided into 1x1 area, 2x2 area, 3x3 area, and 6x6 area respectively
