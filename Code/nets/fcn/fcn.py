...
from nets.fcn.fcn_vgg import vgg16
from nets.fcn.fcn_resnet import resent34
...
#                nn.BatchNorm2d(32),
            ...
            self.stage1 = nn.Sequential(*list(backbone.children())[:10])    # 1/4
            self.stage2 = nn.Sequential(*list(backbone.children())[10:17])  # 1/8
            self.stage3 = nn.Sequential(*list(backbone.children())[17:24])  # 1/16
            self.stage4 = nn.Sequential(*list(backbone.children())[24:31])  # 1/32
