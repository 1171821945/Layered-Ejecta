...
class VGG(nn.Module):
    ...
    def forward(self, x):
        ...
        i = (len(self.features)-5)//13
        feat1 = self.features[0:i*2 ](x)
        feat2 = self.features[i*2 :i*4+1 ](feat1)
        feat3 = self.features[i*4+1 :i*7+2](feat2)
        feat4 = self.features[i*7+2:i*10+3](feat3)
        feat5 = self.features[i*10+3:-1](feat4)
